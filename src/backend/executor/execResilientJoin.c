		...
		int expectedTupWidth, Size memoryQuota, bool roleReversed)
{
	 ...
	 *
	 * TODO rahmaf2 05/30/2015: Bypass SpillableProbeTupleReader if no spilling (#93663114)
	 */
	 ...
	 *
	 * TODO rahmaf2 04/29/2015: Configurable number of memory contexts either through guc or
	 * derived from stats and memory quota (#93588304)
	 */
...
GetMaxSpilledPartitionSize(ResilientJoiner *joiner)
{
	...
	/* TODO rahmaf2 05/30/2015: find the maximum size of the spilled partitions (#87860332) */
	return 0;
}
...
DetermineJoinAlgorithm(ResilientHashJoiner *hashJoiner)
{
	...
	/* TODO rahmaf2 04/29/2015: Enable NLJ switching (#87860332) */
...
{
	/*
	 * TODO rahmaf2 04/29/2015: introduce guc to control "k" (i.e., number of largest
	 * buckets to find (#93588304)
	 */
	int HEAP_SIZE = 64;
	 ...
	 * TODO rahmaf2 04/29/2015: introduce guc to control percentage of memory to free (#93588304)
	 */
...
ChooseHashTableSizeForImpreciseStat(uint64 tupCount, int tupWidth, Size memoryQuota, int *numBuckets, int *numSpillFiles)
{
	...
	if (allTupSizeWithOverhead > memoryQuota)
	{
		...
		/*
		 * TODO rahmaf2 04/29/2015: maximize memory utilization by increasing bucket
		 * count if we have free memory, ignoring gp_hashjoin_tuples_per_bucket (#93588438)
		 */
	...
	*numBuckets = primeBucketCount;
	...
	/*
	 * TODO rahmaf2 04/29/2015: Introduce minimum number of spill files guc to guard against
	 * wrong stat (#93588304)
	 */
