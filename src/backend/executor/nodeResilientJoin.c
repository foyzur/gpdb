...
{
	/* TODO rahmaf2 04/29/2015: Implement rescan (#91735480) */
}
...
{
	/* TODO rahmaf2 04/29/2015: Implement eager free (#90967632) */
}
...
CollectResilientJoinStats(PlanState *planState, struct StringInfoData *buf)
{
	...
	if (instr->execmemused > 50000000)
	{
		dump_memory_allocation("/tmp/memalloc_big.csv");
	}
...
{
	/*
	 * TODO rahmaf2 04/29/2015: Take out the HashJoin from assert once
	 * we have proper ResilientJoin node (#93585476)
	 */
