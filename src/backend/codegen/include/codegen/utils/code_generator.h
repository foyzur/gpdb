...
class CodeGenerator {
 public:
  ...
  llvm::Function* CreateFunctionTypeDef(
      const llvm::Twine& name,
      const llvm::GlobalValue::LinkageTypes linkage
          = llvm::GlobalValue::ExternalLinkage);
  ...
  /**
    ...
    FunctionType GetFunctionPointerTypeDef(const std::string& function_name);
...
// ----------------------------------------------------------------------------
// Implementation of CodeGenerator::GetTypeDefFunctionPointer &
// CodeGenerator::CreateFunctionPointer().
...
/**
 * @brief Partial specialization of FunctionTypeUnpacker
...
public:
  ...
  static llvm::Function* CreateFunctionHelper(gpcodegen::CodeGenerator* code_generator,
                                              const llvm::Twine& name,
                                                  const llvm::GlobalValue::LinkageTypes linkage
                                                      = llvm::GlobalValue::ExternalLinkage) {
    return code_generator->CreateFunction<ReturnType, ArgumentTypes...>(name, linkage);
  }
};
} // namespace code_generator_detail
