...
class runsql(SQLConcurrencyTestCase):
    """
    @db_name memory_quota
    """
    def run_test(self):
        # overriding the runtests so that we can write order of execution of queries
        ...
        order_out_file = open ( self._get_absolute_filename('../verification/' + 'execorder.out'), 'a' )
