...
class test_safezone_memoryquota(ScenarioTestCase):
    """
    @author ramans2
    @created 2014-04-03 12:00:00
    @modified 2014-04-25 12:00:00
    @db_name memory_quota_1GB
    @product_version gpdb:[4.2.0.0-MAIN]
    @description Tests that check for safezone with memory quota
    """
    @classmethod
    def setUpClass(cls):
        super(test_safezone_memoryquota, cls).setUpClass()
        # Add users to pg_hba
        ...
        # Set up GUC max_connections, max_prepared_transactions, gp_resqueue_memory_policy_auto_fixed_mem
    ...
    def setUp(self):
        super(test_safezone_memoryquota, self).setUp()
    ...
    def _infer_metadata(self):
        ...
        """
        super(test_safezone_memoryquota, self)._infer_metadata()
    ...
    def test_211_safezone_memoryquota(self):
        """ 
        @memory_limit None
        @statement_count 25
        ...
        @complexity 1
        @description Check safe zone limit for complexity 1 with memory quota
        """
        test_name = self.name.split('.')[1]
        ...
        test_case_list1 = []
        test_case_list1.append("resource_management.memory_quota.safe_zone.scenarios." + test_name + ".runtest.runsql_concurrency")
        self.test_case_scenario.append(test_case_list1)

    def test_212_safezone_memoryquota(self):
        """ 
        @memory_limit None
        @statement_count 20
        @memory_policy eager_free
        ...
        @complexity 2 
        @description Check safe zone limit for complexity 2 with memory quota
        """
        test_name = self.name.split('.')[1]
    ...
    def test_213_safezone_memoryquota(self):
        """ 
        @memory_limit None
        @statement_count 20
        @memory_policy eager_free
        ...
        @concurrency_limit 20
        @complexity 3
        @description Check safe zone limit for complexity 3 with memory quota
        """
        test_name = self.name.split('.')[1]
    ...
    def test_311_safezone_memoryquota(self):
        """
        @memory_limit 6000MB
        @statement_count 50
        @memory_policy auto
        ...
        @concurrency_limit 20
        @complexity 1 
        @description Check safe zone limit for complexity 1 with memory quota (auto) and memory limit
        """
        test_name = self.name.split('.')[1]
    ...
    def test_312_safezone_memoryquota(self):
        """
        @memory_limit 6000MB
        @statement_count 50
        @memory_policy auto
        ...
        @complexity 2 
        @description Check safe zone limit for complexity 2 with memory quota (auto) and memory limit
        """
        test_name = self.name.split('.')[1]
    ...
    def donttest_313_safezone_memoryquota(self):
        """
        @memory_limit 6000MB
        @statement_count 120
        @memory_policy auto
        ...
        @complexity 3
        @description Check safe zone limit for complexity 3 with memory quota (auto) and memory limit
        """
        test_name = self.name.split('.')[1]
