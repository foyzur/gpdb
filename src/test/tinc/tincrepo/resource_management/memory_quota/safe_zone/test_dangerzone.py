...
class test_dangerzone(ScenarioTestCase):
    """
    @author ramans2
    ...
    @classmethod
    def setUpClass(cls):
        super(test_dangerzone, cls).setUpClass()
        # Add users to pg_hba
    ...
    def setUp(self):
        super(test_dangerzone, self).setUp()
    ...
    def _infer_metadata(self):
        ...
        """
        super(test_dangerzone, self)._infer_metadata()
    ...
    def test_121_dangerzone_memoryquota_none(self):
        """ 
        @memory_limit None
        @statement_count 45
        @memory_policy None
        ...
        @complexity 1
        @description Check danger zone limit for complexity 1 without memory quota. Should throw OOM
        """
        test_name = self.name.split('.')[1]
    ...
    def test_122_dangerzone_memoryquota_none(self):
        """ 
        @memory_limit None
        @statement_count 40
        @memory_policy None
        ...
        @complexity 2
        @description Check danger zone limit for complexity 2 without memory quota. Should throw OOM
        """
        test_name = self.name.split('.')[1]
    ...
    def test_123_dangerzone_memoryquota_none(self):
        """ 
        @memory_limit None
        @statement_count 40
        @memory_policy None
        ...
        @concurrency_limit 40
        @complexity 3
        @description Check danger zone limit for complexity 3 without memory quota. Should throw OOM
        """
        test_name = self.name.split('.')[1]
