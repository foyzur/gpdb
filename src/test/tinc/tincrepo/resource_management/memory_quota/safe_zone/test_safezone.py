...
class test_safezone(ScenarioTestCase):
    """
    @author ramans2
    ...
    @classmethod
    def setUpClass(cls):
        super(test_safezone, cls).setUpClass()
        # Add users to pg_hba
    ...
    def setUp(self):
        super(test_safezone, self).setUp()
    ...
    def _infer_metadata(self):
        ...
        """
        super(test_safezone, self)._infer_metadata()
    ...
    def test_111_safezone_memoryquota_none(self):
        """ 
        @memory_limit None
        @statement_count 18
        @memory_policy None
        ...
        @complexity 1
        @description Check safe zone limit for complexity 1 without memory quota 
        """
        test_name = self.name.split('.')[1]
    ...
    def test_112_safezone_memoryquota_none(self):
        """ 
        @memory_limit None
        @statement_count 10
        @memory_policy None
        ...
        @complexity 2
        @description Check safe zone limit for complexity 2 without memory quota 
        """
        test_name = self.name.split('.')[1]
    ...
    def test_113_safezone_memoryquota_none(self):
        """ 
        @memory_limit None
        @statement_count 7
        @memory_policy None
        ...
        @concurrency_limit 7
        @complexity 3
        @description Check safe zone limit for complexity 3 without memory quota 
        """
        test_name = self.name.split('.')[1]
